...
password = quote_plus('!B1ll1n6_1dF')
...
ssh_server = SSHTunnelForwarder(
   ...
   # local_bind_address=('0.0.0.0', 44306)  # Alamat dan port lokal untuk mengakses MySQL
)
...
class ApplicationConfig:
    ...
    z = f"mysql+pymysql://billing_idf:!B1ll1n6_1dF@127.0.0.1:{ssh_server.local_bind_port}/billing_idf?charset=latin1"
    print(z)
    SQLALCHEMY_BINDS = {
        'dbrudi': z
    }
